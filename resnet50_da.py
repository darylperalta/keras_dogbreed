...
checkpointpath="/media/airscan/Data/AIRSCAN/EE298F/dogbreed/resnet50_weights/resnet50-weights-improvement-{epoch:02d}.hdf5"
...
#sub.head(10358)
df_test.to_csv('pred_mnet_da.csv', index=None)
