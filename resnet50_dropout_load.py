...
model = load_model('/media/airscan/Data/AIRSCAN/EE298F/dogbreed/resnet50_dropout/resnet50-weights-improvement-89.hdf5')
model.summary()
...
model.fit_generator(train_generator,
                    ...
                    epochs=epochs, validation_data=validation_generator,validation_steps=num_batches, verbose =1, initial_epoch=91,callbacks=[checkpoint])
#model.fit_generator(train_generator,
#                    steps_per_epoch=5,
