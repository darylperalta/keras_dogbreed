...
checkpointpath="/media/airscan/Data/AIRSCAN/EE298F/dogbreed/xception_rlr_weights/xception-weights-improvement-{epoch:02d}.hdf5"
...
model = load_model('/media/airscan/Data/AIRSCAN/EE298F/dogbreed/xception_rlr_weights/xception-weights-improvement-10.hdf5')
model.summary()
...
csv_logger = CSVLogger('training_xception_rlr2.log')

model.fit_generator(train_generator,
                    steps_per_epoch=num_batches,
                    epochs=epochs, validation_data=validation_generator,validation_steps=num_batches, verbose =1,initial_epoch=11,callbacks=[checkpoint, csv_logger])
#model.fit_generator(train_generator,
#                    steps_per_epoch=5,
